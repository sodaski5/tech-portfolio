...
export const Banner = () => {
  ...
  const toRotate = [ "- Software Engineer", "- Fullstack Developer", "- QA Engineer" ];
  const period = 2000;
            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Sadiq`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Software Engineer", "Fullstack Developer", "UX/UI Designer" ]'><span className="wrap">{text}</span></span></h1>
                  <p>5 years of experience in Software Engineering with 4 years of professional experience building large-scale enterprise applications, web applications, and PV testing.<br></br>Proficient in Full-stack development using Angular, JavaScript, Next.js, React, TypeScript.<br></br>Experience in cloud computing working with AWS, GCP, Docker, Kubernetes and related
